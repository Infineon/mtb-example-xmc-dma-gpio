...
The following example will clone the "[DMA GPIO](https://github.com/Infineon/mtb-example-xmc-dma-gpio)" application with the desired name "DMAGPIO" configured for the *KIT_XMC47_RELAX_V1* BSP into the specified working directory, *C:/mtb_projects*:
